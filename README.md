...
1. клонуємо програму та переходимо до todo-list-appкаталогу
2. Створюємо образ Docker за допомогою команди "docker build ."
![44](scr/44.jpg) <br>
3. повторно запускаємо команду , не вносячи жодних змін. Подальші збірки після початкової виконуються швидше завдяки механізму кешування, доки команди та контекст залишаються незмінними. Docker кешує проміжні рівні, створені під час процесу збірки. Коли ви перебудовуєте образ, не вносячи жодних змін у файл Docker або вихідний код, Docker може повторно використовувати кешовані шари, значно прискорюючи процес створення.
![45](scr/45.jpg) <br>
4. оновлюємо Dockerfile, щоб package.jsonспочатку скопіювати файл, встановити залежності, а потім скопіювати все інше
![46](scr/46.jpg) <br>
5. створюємо файл .dockerignoreу тій же папці, що й Dockerfile, з наступним вмістом
![47](scr/47.jpg) <br>
6. створюємо новий образ
![48](scr/48.jpg) <br>
7. вносимо зміни у src/static/index.htmlфайл (наприклад, змініть назву на «The Awesome Todo App»).
![49](scr/49.jpg) <br>
8. створюємо новий образ. Зауважимо, що збірка була набагато швидшою. кілька кроків використовують попередньо кешовані шари.
![50](scr/50.jpg) <br>
   ### Багатоетапні збірки
